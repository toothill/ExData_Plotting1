...
legend("topright", lty = c(1, 1, 1), text.width = 50000, col= c("black", "red", "blue"), legend= c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
dev.copy(png, file = paste(work_dir, "plot3.png", sep = ""), width = 480, height = 480)
dev.off()
